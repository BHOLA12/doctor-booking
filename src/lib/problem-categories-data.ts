...
export const PROBLEM_CATEGORIES: ProblemCategory[] = [
  ...
  { id: "c3", label: "Stomach Care", slug: "stomach-care", emoji: "🫃", color: "from-orange-50 to-orange-100", description: "Effective relief from acidity, indigestion, bloating, and gas.", image: "/images/categories/syrup.webp" },
  ...
  { id: "c5", label: "Bone & Joint", slug: "bone-joint", emoji: "🦴", color: "from-blue-50 to-blue-100", description: "Pain relief and strengthening for joints, bones, and cartilage.", image: "/images/tests/vitamin-test.png" },
  ...
  { id: "c7", label: "Derma Care", slug: "derma-care", emoji: "✨", color: "from-pink-50 to-pink-100", description: "Solutions for skin infections, allergies, acne, and pigmentation.", image: "/images/categories/tablet.webp" },
  { id: "c8", label: "Respiratory", slug: "respiratory", emoji: "🫁", color: "from-cyan-50 to-cyan-100", description: "Relief for asthma, cough, allergies, and lung health.", image: "/images/tests/covid-test.png" },
  { id: "c9", label: "Eye Care", slug: "eye-care", emoji: "👁️", color: "from-indigo-50 to-indigo-100", description: "Lubricating drops and supplements for vision and eye fatigue.", image: "/images/categories/capsule.webp" },
  ...
  { id: "c11", label: "Cancer Support", slug: "cancer-care", emoji: "🎗️", color: "from-slate-50 to-slate-100", description: "Supportive oncology medicines, chemotherapy aids, and specialty vitamins.", image: "/images/categories/injection.webp" },
  { id: "c12", label: "Neuro & Brain", slug: "neuro-brain", emoji: "🧠", color: "from-violet-50 to-violet-100", description: "Solutions for migraine, epilepsy, nerve pain, and cognitive health.", image: "/images/categories/capsule.webp" },
  { id: "c13", label: "Cold & Fever", slug: "cold-fever", emoji: "🤒", color: "from-amber-50 to-amber-100", description: "Antipyretics, cough syrups, and anti-infectives for seasonal illnesses.", image: "/images/categories/tablet.webp" },
  { id: "c14", label: "Women Health", slug: "womens-health", emoji: "🤰", color: "from-fuchsia-50 to-fuchsia-100", description: "PCOS management, pregnancy supplements, iron/calcium, and hormone care.", image: "/images/tests/hormonal-test.png" },
  { id: "c15", label: "Child Care", slug: "child-care", emoji: "👶", color: "from-yellow-50 to-yellow-100", description: "Drops, syrups, and kid-friendly nutrition and wellness formulations.", image: "/images/categories/syrup.webp" },
