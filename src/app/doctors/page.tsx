      ...
      <div className="mt-16 bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/60 dark:border-slate-800 shadow-sm flex flex-col md:flex-row justify-between items-center gap-4 hover:shadow-md transition-shadow duration-300">
        <div className="flex-1 text-left">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">
            Are you a Verified Medical Professional? Join the Clinik<span className="text-cta">Book</span> Care Network.
          </h2>
        ...
        <Link href="/register/doctor" className="w-full md:w-auto shrink-0">
          <button className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-cta hover:bg-[#025684] text-white font-semibold text-sm rounded-xl transition-all duration-300 shadow-sm active:scale-[0.99] cursor-pointer whitespace-nowrap border-none">
